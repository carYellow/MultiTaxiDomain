...
class TaxiEnv(gym.Env):
    ...
    def __init__(self, _=0, num_taxis: int = 2, num_passengers: int = 2, max_fuel: list = None,
        ...
        if domain_map is None:
            self.desc = np.asarray(MAP3, dtype='c')
        else:
    ...
    def reset(self) -> dict:
        ...
        passengers_start_location = [self.passengers_locations[0], self.passengers_locations[3]]
        passengers_destinations = [self.passengers_locations[2], self.passengers_locations[4]]
